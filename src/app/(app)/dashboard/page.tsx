      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="card p-6 opacity-50 cursor-not-allowed">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-semibold text-slate-400">More features</h3>
              <p className="text-sm text-slate-400 mt-1">Additional modules coming soon.</p>
              <span className="inline-flex items-center text-xs text-slate-400 font-medium mt-3">Coming soon</span>
            </div>
          </div>
        </div>
      </div>
